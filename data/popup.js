...
app.controller('PopupController', function($scope, $localStorage, $http) {
  ...
  $scope.getInfo = function(){
    executeContentPageScript('getAllInfo');
  };
  ...
  $scope.logIn = function() {
    executeContentPageScript('logIn', [$scope.auth.user, $scope.auth.pass]);
  };
  ...
  $scope.activateTree = function() {
    executeContentPageScript('activateTree', [getPathForActivation($scope.pageDetails.location.pathname)]);
  };
  ...
  $scope.activatePage = function() {
    executeContentPageScript('activatePage', [getPathForActivation($scope.pageDetails.location.pathname)]);
  };
  ...
  $scope.deactivatePage = function() {
    executeContentPageScript('deactivatePage', [getPathForActivation($scope.pageDetails.location.pathname)]);
  };
  ...
  $scope.clearClientLibs = function() {
    executeContentPageScript('clearClientLibs');
  };
  ...
  $scope.clearCompiledJSPs = function() {
    executeContentPageScript('clearCompiledJSPs');
  };
  ...
  $scope.clearLinkChecker = function() {
    executeContentPageScript('clearLinkChecker');
  };
